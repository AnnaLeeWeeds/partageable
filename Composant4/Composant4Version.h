...
#define COMPOSANT_VERSION ComposantVersion_5,ComposantVersion_6,ComposantVersion_7,ComposantVersion_8
...
#define COMPOSANT_VERSION_STR VERSION_TEXT(ComposantVersion_5,ComposantVersion_6,ComposantVersion_7,ComposantVersion_8)
